---
name: sooth-analyze
description: Reason exhaustively over the evidence to test competing hypotheses. Deploys a range of methods (deductive, inductive, abductive, analogical, causal, probabilistic, falsification by assuming the opposite, thought experiments, first-principles, systems), run in parallel and cross-checked, deliberately more exhaustive than a human consultant. Runs a disproof pass on any favoured answer. Use after /sooth-research and before /sooth-synthesize. Refuses to synthesise or recommend.
---
...
- **Falsification (assume the opposite).** Take your leading hypothesis, assume it is false, and build the strongest possible case for the opposite. Then look for the evidence that would prove the original wrong. A hypothesis you have only ever tried to confirm has not been tested. Do this for every hypothesis you are tempted to favour.
...
**Before you favour any answer, run the disproof pass.** For the hypothesis you are drifting towards, spend as much effort trying to kill it as you spent building it. The one that survives a serious attempt to disprove it is the one worth carrying to `/sooth-synthesize`; a favourite that was never attacked is advocacy waiting to happen.
